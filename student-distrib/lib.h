...
void update_cursor(int y, int x);//added
void scroll_video_mem(); //added
int get_screen_xy(int* x, int* y); //added
void putc_with_scrolling(uint8_t c); //added
void backspace();//added
